...
- `src/` — verbatim upstream source (only the mandatory
  `Copyright 2026 Andrew Yates` header added at the top of every file
...
`CARGO_TARGET_DIR=/tmp/ty-agent-syn cargo check --profile agent --workspace`
