...
/// Magic bytes identifying a TY checkpoint fingerprint file
pub(super) const FINGERPRINT_MAGIC: &[u8; 8] = b"TYFP0001";

/// Magic bytes identifying a TY checkpoint parent map file
pub(super) const PARENTS_MAGIC: &[u8; 8] = b"TYPM0001";

/// Magic bytes identifying a TY checkpoint depths file
pub(super) const DEPTHS_MAGIC: &[u8; 8] = b"TYDP0001";
