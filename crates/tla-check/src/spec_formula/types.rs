...
pub struct SpecFormula {
    ...
    ///
    /// This captures the temporal formula's next-step semantics only. TY and
...
pub enum FairnessConstraint {
    ...
    Weak {
        /// The subscript variables (`vars` in `WF_vars`).
        vars: String,
        /// The fair action's name or rendered text.
        action: String,
    ...
    Strong {
        /// The subscript variables (`vars` in `SF_vars`).
        vars: String,
        /// The fair action's name or rendered text.
        action: String,
        /// The action expression's syntax node (for inline expressions)
