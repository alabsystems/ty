...
pub(super) fn emit_finalize_reports(
    ...
    // Output profiling stats when TY_PARALLEL_PROFILING=1.
    ...
    // Part of #606: Output disabled action stats when TY_DISABLED_ACTION_STATS=1
    ...
    // Output detailed timing when TY_TIMING=1
    if timing_enabled() {
    ...
    // Output detailed enumeration profiling when TY_PROFILE_ENUM_DETAIL=1
