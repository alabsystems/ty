...
impl ParallelProfilingEnvGuard {
    fn set(value: &str) -> Self {
        ...
        crate::env_guard::set_var(super::super::PARALLEL_PROFILING_ENV, value);
        Self {
            previous,
            lock: Some(lock),
        }
...
impl Drop for ParallelProfilingEnvGuard {
    fn drop(&mut self) {
        match self.previous.take() {
            Some(value) => crate::env_guard::set_var(super::super::PARALLEL_PROFILING_ENV, value),
            None => crate::env_guard::remove_var(super::super::PARALLEL_PROFILING_ENV),
        }
        self.lock.take();
    }
}
...
fn test_parallel_profiling_flag_reads_release_env_value() {
    ...
    assert!(
        ...
        "release profiling must honor TY_PARALLEL_PROFILING=1"
    );

    crate::env_guard::set_var(super::super::PARALLEL_PROFILING_ENV, "0");
