...
fn test_parallel_determinism_across_worker_counts() {
    let _serial = super::acquire_interner_lock();
    test_parallel_determinism_across_worker_counts_body();
}

#[cfg_attr(test, ntest::timeout(30_000))]
fn test_parallel_determinism_across_worker_counts_body() {
...
fn test_parallel_stress_repeated_runs() {
    let _serial = super::acquire_interner_lock();
    test_parallel_stress_repeated_runs_body();
}

#[cfg_attr(test, ntest::timeout(60_000))]
fn test_parallel_stress_repeated_runs_body() {
