...
///
/// ```rust,no_run
/// use tla_check::{DiskFingerprintSet, Fingerprint, InsertOutcome, LookupOutcome};
///
/// # fn main() -> std::io::Result<()> {
/// let set = DiskFingerprintSet::new(1_000_000, "/tmp/fp_storage")?;
/// assert_eq!(set.insert_checked(Fingerprint(12345)), InsertOutcome::Inserted);
/// assert_eq!(set.contains_checked(Fingerprint(12345)), LookupOutcome::Present);
/// # Ok(())
/// # }
/// ```
