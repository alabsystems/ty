...
pub use types::{
    ...
    InputInfo, JsonOutput, JsonValue, PrintOutput, PropertyCheckStatsInfo, ResultInfo,
    SearchCompleteness, SoundnessMode, SoundnessProvenance, SourceLocation, SpecInfo, StateDiff,
    StateInfo, StatisticsInfo, StorageStatsInfo, ValueChange, ViolatedProperty, OUTPUT_VERSION,
};
...
pub(crate) use conversion::trace_to_counterexample;
