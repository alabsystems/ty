...
///
/// TY's unified enumerator speculatively evaluates conjuncts as boolean guards.
...
///
/// TY's unified enumerator speculatively evaluates conjuncts as guards before
/// trying structural decomposition. Unlike TLC (which pattern-matches the AST),
/// TY hits runtime errors when expressions reference unresolved variables
