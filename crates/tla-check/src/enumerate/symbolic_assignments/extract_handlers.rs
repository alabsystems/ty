...
pub(super) fn extract_exists_symbolic_assignments(
    ...
    // Lazy powerset/function domains already yield owned candidates in TLC
    // order. Consume them directly instead of retaining the complete domain
    // alongside the accumulated primed values.
