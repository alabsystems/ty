...
// Part of #1433: TY_WARN_INIT_ERRORS removed — unexpected errors are now always warned.
debug_flag!(debug_init_errors, "TY_DEBUG_INIT_ERRORS");
...
/// required `TY_WARN_INIT_ERRORS`). The flag now controls verbose expected-deferral
/// tracing only.
