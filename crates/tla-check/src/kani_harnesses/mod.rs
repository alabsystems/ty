...
//! Kani formal verification harnesses for TY core components
//!
...
use tla_value::Rp;
    ...
    pub fn any_small_seq() -> Value {
        ...
        match choice {
            0 => Value::Seq(Rp::new(Vec::new().into())),
            1 => Value::Seq(Rp::new(vec![Value::Bool(kani::any())].into())),
            2 => {
                let n: i8 = kani::any();
                Value::Seq(Rp::new(vec![Value::int(n as i64)].into()))
            }
            3 => Value::Seq(Rp::new(
    ...
    pub fn any_small_seq_boolonly() -> Value {
        ...
        match choice {
            0 => Value::Seq(Rp::new(Vec::new().into())),
            1 => Value::Seq(Rp::new(vec![Value::Bool(true)].into())),
            2 => Value::Seq(Rp::new(vec![Value::Bool(false)].into())),
            3 => Value::Seq(Rp::new(vec![Value::Bool(true), Value::Bool(false)].into())),
            _ => Value::Seq(Rp::new(
    ...
    pub fn create_nested_func() -> FuncValue {
        ...
        make_func(vec![(Value::int(1), Value::Func(Rp::new(inner)))])
    }
}
