...
fn test_fmt_tlc_fp_format() {
    ...
    // The actual fmt_tlc_fp output depends on TY_TLCFP_DECIMAL env var,
...
fn test_check_module_clears_value_interner_between_runs() {
    ...
    test_check_module_clears_value_interner_between_runs_body();
}

fn test_check_module_clears_value_interner_between_runs_body() {
