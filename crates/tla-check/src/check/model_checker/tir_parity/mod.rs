...
//! - **Parity** (`TY_TIR_PARITY`): shadow-check both AST and TIR paths,
//!   assert results match. Used for validation.
//! - **Eval** (`TY_TIR_EVAL`): use TIR as the primary evaluator for
//!   selected operators. AST path is bypassed.
//!
//! Part of #3354: `TY_LEGACY_EVAL` removed — TIR is the sole evaluation
