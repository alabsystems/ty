...
//! high-branching actions to the symbolic (ay) engine and low-branching
...
//!   AND is within the SMT-compatible fragment. Routed to ay symbolic engine.
...
impl ActionOracle {
    ...
    ///
    /// Used when no SMT compatibility information is available (e.g., non-ay builds).
    #[must_use]
