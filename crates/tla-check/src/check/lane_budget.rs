...
mod tests {
    ...
    fn test_lane_budget_eval_interval_throttle() {
        ...
        assert_eq!(mgr.budget_for(Lane::Bfs), Duration::from_secs(1));
    }
    ...
    fn test_lane_budget_force_override() {
        ...
        mgr.force_budget(Lane::Bmc, Duration::from_secs(5));
        assert_eq!(mgr.budget_for(Lane::Bmc), Duration::from_secs(5));
