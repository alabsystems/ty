...
//! AY self-bootstrap validation tests.
//!
//! These tests demonstrate that ay's symbolic reasoning engines (BMC, PDR,
//! k-induction) provide capabilities that improve TY model checking beyond
...
//!
//! Part of #3744: Self-bootstrap validation — verified ay improves TY
//! symbolic backend.
...
#[test]
fn ay_validation_bmc_finds_deep_bug() {
    let src = r#"
---- MODULE BmcDeepBug ----
VARIABLE count
Init == count = 0
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_bmc_multi_variable_symbolic_bug() {
    let src = r#"
---- MODULE BmcMultiVar ----
VARIABLES x, y
Init == x = 0 /\ y = 0
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_pdr_proves_safety_without_enumeration() {
    let src = r#"
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_pdr_detects_unsafe_spec() {
    let src = r#"
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_pdr_proves_two_variable_safety() {
    let src = r#"
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_kinduction_proves_toggle_property() {
    let src = r#"
---- MODULE KindToggle ----
VARIABLE x
Init == x \in {0, 1}
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_kinduction_proves_stable_property_bmc_cannot() {
    let src = r#"
---- MODULE KindStable ----
VARIABLE x
Init == x = 0
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_kinduction_proves_2_inductive_pipeline() {
    let src = r#"
---- MODULE KindPipeline ----
VARIABLES x, y
Init == x = 0 /\ y = 0
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_bmc_bfs_agree_on_init_violation() {
    let src = r#"
...
// ============================================================================
//
// This test shows the ay engines working together. For a safe spec:
...
#[cfg_attr(test, ntest::timeout(30000))]
#[test]
fn ay_validation_complementary_bmc_kinduction() {
    let src = r#"
