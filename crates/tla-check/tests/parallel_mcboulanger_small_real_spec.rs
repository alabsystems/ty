...
fn run_mcboulanger_small_parallel(
    ...
    let _force_batch_guard = EnvVarGuard::set("TY_FORCE_BATCH", force_batch.then_some("1"));
    let _shared_queue_guard = EnvVarGuard::set("TY_SHARED_QUEUE", shared_queue.then_some("1"));
