...
fn test_bytecode_record_set_field_packing_passes_real_check_path() {
    let _bytecode_vm = common::EnvVarGuard::set("TY_BYTECODE_VM", Some("1"));
    let _bytecode_stats = common::EnvVarGuard::set("TY_BYTECODE_VM_STATS", Some("1"));
...
"#,
    ...
    let _bytecode_vm = common::EnvVarGuard::set("TY_BYTECODE_VM", Some("0"));
    let _bytecode_stats = common::EnvVarGuard::set("TY_BYTECODE_VM_STATS", Some("0"));
    clear_for_test_reset();
