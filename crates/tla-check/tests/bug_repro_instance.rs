...
/// time ./target/release/ty check examples/test/disruptor/Disruptor_SPMC.tla \
///   --config examples/test/disruptor/Disruptor_SPMC.cfg --workers 1
///
/// # Direct (inline TypeOk): ~1.6s
/// time ./target/release/ty check examples/test/disruptor/Disruptor_SPMC_direct.tla \
///   --config examples/test/disruptor/Disruptor_SPMC.cfg --workers 1
///
/// # TLC baseline: ~1s
/// cd ~/tlaplus && time java -cp tytools.jar tlc2.TLC \
///   -config ~/ty/examples/test/disruptor/Disruptor_SPMC.cfg \
///   ~/ty/examples/test/disruptor/Disruptor_SPMC.tla -workers 1
/// ```
#[cfg_attr(test, ntest::timeout(10000))]
#[test]
