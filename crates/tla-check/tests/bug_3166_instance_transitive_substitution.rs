...
fn exact_state_count_config(init: &str, next: &str, invariant: &str) -> Config {
    Config {
...
"#,
    ...
    let config = exact_state_count_config("Init", "Next", "OuterInv");
...
fn bug_3166_instance_multi_variable_substitution() {
    ...
    let config = exact_state_count_config("Init", "Next", "SysInv");
