...
fn test_jit_duplicate_self_loops_preserve_transitions_and_avoid_false_deadlock() {
    let _jit = common::EnvVarGuard::set("TY_JIT", Some("1"));
    let _show_tiers = common::EnvVarGuard::set("TY_SHOW_TIERS", Some("1"));
    let _tier1 = common::EnvVarGuard::set("TY_JIT_TIER1_THRESHOLD", Some("1"));
    let _tier2 = common::EnvVarGuard::set("TY_JIT_TIER2_THRESHOLD", Some("1000000"));
    let _no_diffs = common::EnvVarGuard::set("TY_FORCE_NO_DIFFS", Some("1"));
