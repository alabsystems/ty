...
//! `tla_*` runtime ABI — handle-based FFI for trust_cg-compiled aggregate ops.
//!
//! This module hosts the "Option B" runtime surface chosen by R27
//! (trust_cg runtime-ABI-scope design). `tir_lower.rs` emits
...
#[cold]
#[inline(never)]
pub(crate) fn ty_ffi_abort(msg: &str) -> ! {
...
pub use handle::{
    ...
    tla_handle_box_int, tla_handle_from_scratch, tla_handle_from_state_slot, tla_handle_nil,
    tla_handle_store_to_scratch, TlaHandle, HANDLE_TAG_BITS, HANDLE_TAG_MASK, H_TAG_ARENA,
    H_TAG_BOOL, H_TAG_INT, H_TAG_NIL, H_TAG_STRING, NIL_HANDLE,
};
pub use quantifier::{
...
pub use record_func::{tla_domain, tla_func_apply, tla_func_except, tla_record_get};
pub use seq::{
    ...
    tla_seq_new_8, tla_seq_remove_at, tla_seq_set, tla_seq_subseq, tla_seq_tail,
};
pub use set::{
