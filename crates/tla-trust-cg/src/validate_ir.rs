...
// This structural IR validator is exercised exclusively by the test suite in
// this module; its functions and types have no non-test callers yet but are
// deliberately kept as a developer-facing emission-correctness harness.
#![allow(dead_code)]
...
mod tests {
    ...
    fn test_validate_pipeline_invariant_ir() {
        ...
        let compiled =
            crate::compile::compile_invariant(&func, "inv_valid").expect("should compile");
    ...
    fn test_validate_pipeline_next_state_ir() {
        ...
        let compiled =
            crate::compile::compile_next_state(&func, "next_valid").expect("should compile");
    ...
    fn test_validate_pipeline_multi_function_chunk_ir() {
        ...
        let compiled = crate::compile::compile_spec_invariant(&chunk, 0, "multi_valid")
