...
//! Native trust-codegen regressions for compact record-set TypeInvariant shapes.
...
fn compile_coffeecan_typeinvariant() -> (tla_trust_cg::NativeLibrary, JitInvariantFn) {
