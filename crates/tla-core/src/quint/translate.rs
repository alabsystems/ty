...
//! Translation from Quint IR types to TY AST nodes.
//!
//! The Quint IR uses a flat expression representation with opcodes for built-in
//! operators. This module maps each Quint opcode to the corresponding TY
...
use super::ir::{QuintDeclaration, QuintDef, QuintExpr, QuintModule};
...
/// Translate a `QuintModule` into a TY `Module`.
///
...
/// Translate a Quint definition into a TY `OperatorDef`.
...
/// Translate a Quint expression into a TY `Spanned<Expr>`.
