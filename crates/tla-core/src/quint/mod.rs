...
//! Quint JSON IR import: parse `.qnt.json` files into TY AST.
//!
...
//!
//! This module parses that JSON IR and translates it into TY's AST,
//! allowing `ty check` to operate on Quint specs without going
...
/// Parse a Quint JSON IR string and return a list of TY `Module`s.
///
