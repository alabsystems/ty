...
//!
//! Reference: Tseitin encoding with XOR/ITE detection over the cone of
//! influence (standard AIG-to-CNF practice; cf. ABC).
...
pub fn aiger_to_cnf(circuit: &AigerCircuit) -> CnfFormula {
    ...
    // Process in reverse variable order (higher first).
