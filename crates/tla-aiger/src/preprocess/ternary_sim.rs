...
//!
//! This is the classic multi-cycle ternary simulation of ABC's
//! `ternary_sim`. It catches constants that
...
///
/// ty choice: 64 cycles. More cycles catch deeper feedback-loop constants
/// but with diminishing returns; 64 is a good balance for HWMCC-sized
/// circuits.
