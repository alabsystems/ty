...
/// followed by AND gate outputs sorted by dependency depth. Dependent
/// variables get adjacent indices, improving SAT solver watcher list cache
/// behavior.
///
...
pub(crate) fn renumber_variables(ts: &Transys) -> (Transys, usize) {
    ...
    // Build priority-ordered variable list:
