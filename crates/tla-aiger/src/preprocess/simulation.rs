...
//!   from unit clauses.
//!
//! SAT-seeded simulation (ay-sat init enumeration + forward simulation) is in
...
/// ty choice: 256 packed 64-bit rounds (= 16,384 bit-patterns) for
...
///
/// ty choice: SIM_ROUNDS (256) packed 64-bit rounds for 16,384 bit-patterns
/// of discrimination, giving very strong candidate precision.
