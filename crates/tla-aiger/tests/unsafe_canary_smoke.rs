...
const CANARY_BENCHMARKS: &[&str] = &[
    "bitlevel/safety/2019/mann/data-integrity/unsafe/circular_pointer_top_w8_d16_e0.aig", // 11.5 KB
    "bitlevel/safety/2019/mann/data-integrity/unsafe/shift_register_top_w16_d16_e0.aig",  // 18.9 KB
    "bitlevel/safety/2019/mann/data-integrity/unsafe/circular_pointer_top_w8_d32_e0.aig", // 21.0 KB
    "bitlevel/safety/2019/mann/data-integrity/unsafe/arbitrated_top_n3_w8_d16_e0.aig",    // 35.9 KB
    "bitlevel/safety/2019/mann/data-integrity/unsafe/circular_pointer_top_w32_d16_e0.aig", // 42.5 KB
    "bitlevel/safety/2019/mann/data-integrity/unsafe/arbitrated_top_n2_w8_d32_e0.aig", // 45.5 KB
    "bitlevel/safety/2019/mann/data-integrity/unsafe/arbitrated_top_n4_w16_d8_e0.aig", // 47.3 KB
];

fn assert_sat_or_panic(rel_path: &str) {
    let path = hwmcc_benchmarks_root().join(rel_path);
    let path = path.to_str().expect("benchmark path is valid UTF-8");
