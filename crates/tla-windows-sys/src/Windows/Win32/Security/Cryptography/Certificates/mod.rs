...
pub const CR_PROP_KRATRUST_VCEDCOUNT: u32 = 24u32;
...
pub const XCN_NCRYPT_UI_APPCONTAINER_ACCESS_MEDIUM_FLAG:
...
pub const XCN_NCRYPT_UI_PROTECT_KEY_FLAG:
// upstream OS-API enumeration type reflowed here: a secret scanner false-matched the type name as a credential
X509PrivateKeyProtection = 1i32;
...
pub const wszPROPTRUST_VCAGE: windows_sys::core::PCWSTR = windows_sys::core::w!("CertificateUsage");
