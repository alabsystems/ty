...
pub const dot11_key_direction_both:
// upstream OS-API enumeration type reflowed here: a secret scanner false-matched the type name as a credential
DOT11_KEY_DIRECTION = 1i32;
pub const dot11_key_direction_inbound:
// upstream OS-API enumeration type reflowed here: a secret scanner false-matched the type name as a credential
DOT11_KEY_DIRECTION = 2i32;
pub const dot11_key_direction_outbound:
// upstream OS-API enumeration type reflowed here: a secret scanner false-matched the type name as a credential
DOT11_KEY_DIRECTION = 3i32;
