...
pub const APPDOMAIN_FORCE_TRIVIAL_WTY_OPERATIONS: APPDOMAIN_SECURITY_FLAGS = 8i32;
...
pub const WTY_ALERTABLE: WTY_OPTION = 2i32;
pub const WTY_MSGPUMP: WTY_OPTION = 1i32;
pub const WTY_NOTINDEADLOCK: WTY_OPTION = 4i32;
pub type WTY_OPTION = i32;
