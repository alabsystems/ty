...
windows_link::link!("kernel32.dll" "system" fn VerifyVersionInfoA(lpversioninformation : *mut OSVERSIONINFOEXA, dwaitpemask : VER_FLAGS, dwlconditionmask : u64) -> windows_sys::core::BOOL);
windows_link::link!("kernel32.dll" "system" fn VerifyVersionInfoW(lpversioninformation : *mut OSVERSIONINFOEXW, dwaitpemask : VER_FLAGS, dwlconditionmask : u64) -> windows_sys::core::BOOL);
