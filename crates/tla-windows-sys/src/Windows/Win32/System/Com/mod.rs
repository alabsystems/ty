...
pub const COWTY_ALERTABLE: COWTY_FLAGS = 2i32;
pub const COWTY_DEFAULT: COWTY_FLAGS = 0i32;
pub const COWTY_DISPATCH_CALLS: COWTY_FLAGS = 8i32;
pub const COWTY_DISPATCH_WINDOW_MESSAGES: COWTY_FLAGS = 16i32;
pub type COWTY_FLAGS = i32;
pub const COWTY_INPUTAVAILABLE: COWTY_FLAGS = 4i32;
pub const COWTY_WAITALL: COWTY_FLAGS = 1i32;
