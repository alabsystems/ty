...
windows_link::link!("advapi32.dll" "system" fn GetThreadWaitChain(wcthandle : *const core::ffi::c_void, context : usize, flags : WTY_CHAIN_THREAD_OPTIONS, threadid : u32, nodecount : *mut u32, nodeinfoarray : *mut WAITCHAIN_NODE_INFO, iscycle : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
...
windows_link::link!("advapi32.dll" "system" fn OpenThreadWaitChainSession(flags : OPEN_THREAD_WTY_CHAIN_SESSION_FLAGS, callback : PWAITCHAINCALLBACK) -> *mut core::ffi::c_void);
...
pub const MAXIMUM_WTY_OBJECTS_EXCEEDED: BUGCHECK_ERROR = 12u32;
...
pub type OPEN_THREAD_WTY_CHAIN_SESSION_FLAGS = u32;
...
pub type WTY_CHAIN_THREAD_OPTIONS = u32;
pub const WCT_ASYNC_OPEN_FLAG: OPEN_THREAD_WTY_CHAIN_SESSION_FLAGS = 1u32;
...
pub const WCT_OUT_OF_PROC_COM_FLAG: WTY_CHAIN_THREAD_OPTIONS = 2u32;
pub const WCT_OUT_OF_PROC_CS_FLAG: WTY_CHAIN_THREAD_OPTIONS = 4u32;
pub const WCT_OUT_OF_PROC_FLAG: WTY_CHAIN_THREAD_OPTIONS = 1u32;
