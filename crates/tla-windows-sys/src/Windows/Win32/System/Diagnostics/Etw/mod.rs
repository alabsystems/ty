...
pub type ETW_PROVIDER_TRTY_TYPE = i32;
...
pub const EtwProviderTraitDecodeGuid: ETW_PROVIDER_TRTY_TYPE = 2i32;
pub const EtwProviderTraitTypeGroup: ETW_PROVIDER_TRTY_TYPE = 1i32;
pub const EtwProviderTraitTypeMax: ETW_PROVIDER_TRTY_TYPE = 3i32;
