...
pub const WaitAll: WTY_TYPE = 0i32;
pub const WaitAny: WTY_TYPE = 1i32;
pub const WaitDequeue: WTY_TYPE = 3i32;
pub const WaitDpc: WTY_TYPE = 4i32;
pub const WaitNotification: WTY_TYPE = 2i32;
