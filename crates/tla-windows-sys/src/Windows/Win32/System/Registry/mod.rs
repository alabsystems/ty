...
windows_link::link!("advapi32.dll" "system" fn RegGetValueA(hkey : HKEY, lpsubkey : windows_sys::core::PCSTR, lpvalue : windows_sys::core::PCSTR, dwflags : REG_ROUTINE_FLAGS, pdwaitpe : *mut REG_VALUE_TYPE, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn RegGetValueW(hkey : HKEY, lpsubkey : windows_sys::core::PCWSTR, lpvalue : windows_sys::core::PCWSTR, dwflags : REG_ROUTINE_FLAGS, pdwaitpe : *mut REG_VALUE_TYPE, pvdata : *mut core::ffi::c_void, pcbdata : *mut u32) -> super::super::Foundation:: WIN32_ERROR);
...
windows_link::link!("advapi32.dll" "system" fn RegSetKeyValueA(hkey : HKEY, lpsubkey : windows_sys::core::PCSTR, lpvaluename : windows_sys::core::PCSTR, dwaitpe : u32, lpdata : *const core::ffi::c_void, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn RegSetKeyValueW(hkey : HKEY, lpsubkey : windows_sys::core::PCWSTR, lpvaluename : windows_sys::core::PCWSTR, dwaitpe : u32, lpdata : *const core::ffi::c_void, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn RegSetValueA(hkey : HKEY, lpsubkey : windows_sys::core::PCSTR, dwaitpe : REG_VALUE_TYPE, lpdata : windows_sys::core::PCSTR, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn RegSetValueExA(hkey : HKEY, lpvaluename : windows_sys::core::PCSTR, reserved : u32, dwaitpe : REG_VALUE_TYPE, lpdata : *const u8, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn RegSetValueExW(hkey : HKEY, lpvaluename : windows_sys::core::PCWSTR, reserved : u32, dwaitpe : REG_VALUE_TYPE, lpdata : *const u8, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
windows_link::link!("advapi32.dll" "system" fn RegSetValueW(hkey : HKEY, lpsubkey : windows_sys::core::PCWSTR, dwaitpe : REG_VALUE_TYPE, lpdata : windows_sys::core::PCWSTR, cbdata : u32) -> super::super::Foundation:: WIN32_ERROR);
