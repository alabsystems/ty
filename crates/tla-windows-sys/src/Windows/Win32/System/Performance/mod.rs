...
windows_link::link!("pdh.dll" "system" fn PdhGetFormattedCounterValue(hcounter : PDH_HCOUNTER, dwformat : PDH_FMT, lpdwaitpe : *mut u32, pvalue : *mut PDH_FMT_COUNTERVALUE) -> u32);
...
windows_link::link!("pdh.dll" "system" fn PdhGetRawCounterValue(hcounter : PDH_HCOUNTER, lpdwaitpe : *mut u32, pvalue : *mut PDH_RAW_COUNTER) -> u32);
