...
windows_link::link!("wininet.dll" "system" fn CommitUrlCacheEntryBinaryBlob(pwszurlname : windows_sys::core::PCWSTR, dwaitpe : u32, ftexpiretime : super::super::Foundation:: FILETIME, ftmodifiedtime : super::super::Foundation:: FILETIME, pbblob : *const u8, cbblob : u32) -> u32);
...
windows_link::link!("wininet.dll" "system" fn GetUrlCacheEntryBinaryBlob(pwszurlname : windows_sys::core::PCWSTR, dwaitpe : *mut u32, pftexpiretime : *mut super::super::Foundation:: FILETIME, pftaccesstime : *mut super::super::Foundation:: FILETIME, pftmodifiedtime : *mut super::super::Foundation:: FILETIME, ppbblob : *mut *mut u8, pcbblob : *mut u32) -> u32);
...
windows_link::link!("wininet.dll" "system" fn HttpPushClose(hwait : HTTP_PUSH_WTY_HANDLE));
windows_link::link!("wininet.dll" "system" fn HttpPushEnable(hrequest : *const core::ffi::c_void, ptransportsetting : *const HTTP_PUSH_TRANSPORT_SETTING, phwait : *mut HTTP_PUSH_WTY_HANDLE) -> u32);
windows_link::link!("wininet.dll" "system" fn HttpPushWait(hwait : HTTP_PUSH_WTY_HANDLE, etype : HTTP_PUSH_WTY_TYPE, pnotificationstatus : *mut HTTP_PUSH_NOTIFICATION_STATUS) -> u32);
...
windows_link::link!("wininet.dll" "system" fn PrivacyGetZonePreferenceW(dwzone : u32, dwaitpe : u32, pdwtemplate : *mut u32, pszbuffer : windows_sys::core::PWSTR, pdwbufferlength : *mut u32) -> u32);
windows_link::link!("wininet.dll" "system" fn PrivacySetZonePreferenceW(dwzone : u32, dwaitpe : u32, dwtemplate : u32, pszpreference : windows_sys::core::PCWSTR) -> u32);
...
pub type HTTP_PUSH_WTY_HANDLE = *mut core::ffi::c_void;
pub type HTTP_PUSH_WTY_TYPE = i32;
...
pub const HttpPushWaitEnableComplete: HTTP_PUSH_WTY_TYPE = 0i32;
pub const HttpPushWaitReceiveComplete: HTTP_PUSH_WTY_TYPE = 1i32;
pub const HttpPushWaitSendComplete: HTTP_PUSH_WTY_TYPE = 2i32;
