...
windows_link::link!("ws2_32.dll" "system" fn WSAWaitForMultipleEvents(cevents : u32, lphevents : *const super::super::Foundation:: HANDLE, fwaitall : windows_sys::core::BOOL, dwtimeout : u32, falertable : windows_sys::core::BOOL) -> super::super::Foundation:: WTY_EVENT);
...
pub const TCPSTATE_FIN_WTY_1: TCPSTATE = 5i32;
pub const TCPSTATE_FIN_WTY_2: TCPSTATE = 6i32;
...
pub const WSA_MAXIMUM_WTY_EVENTS: u32 = 64u32;
...
pub const WSA_WTY_EVENT_0: WSA_ERROR = 0i32;
pub const WSA_WTY_FAILED: u32 = 4294967295u32;
pub const WSA_WTY_IO_COMPLETION: WSA_ERROR = 192i32;
pub const WSA_WTY_TIMEOUT: u32 = 258u32;
#[repr(C)]
#[derive(Clone, Copy)]
