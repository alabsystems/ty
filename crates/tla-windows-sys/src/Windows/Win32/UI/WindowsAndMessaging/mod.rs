...
windows_link::link!("user32.dll" "system" fn MsgWaitForMultipleObjects(ncount : u32, phandles : *const super::super::Foundation:: HANDLE, fwaitall : windows_sys::core::BOOL, dwmilliseconds : u32, dwwakemask : QUEUE_STATUS_FLAGS) -> super::super::Foundation:: WTY_EVENT);
windows_link::link!("user32.dll" "system" fn MsgWaitForMultipleObjectsEx(ncount : u32, phandles : *const super::super::Foundation:: HANDLE, dwmilliseconds : u32, dwwakemask : QUEUE_STATUS_FLAGS, dwflags : MSG_WTY_FOR_MULTIPLE_OBJECTS_EX_FLAGS) -> super::super::Foundation:: WTY_EVENT);
...
pub type MSG_WTY_FOR_MULTIPLE_OBJECTS_EX_FLAGS = u32;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const MWMO_ALERTABLE: MSG_WTY_FOR_MULTIPLE_OBJECTS_EX_FLAGS = 2u32;
pub const MWMO_INPUTAVAILABLE: MSG_WTY_FOR_MULTIPLE_OBJECTS_EX_FLAGS = 4u32;
pub const MWMO_NONE: MSG_WTY_FOR_MULTIPLE_OBJECTS_EX_FLAGS = 0u32;
pub const MWMO_WAITALL: MSG_WTY_FOR_MULTIPLE_OBJECTS_EX_FLAGS = 1u32;
