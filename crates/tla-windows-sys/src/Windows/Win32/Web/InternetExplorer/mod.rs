...
windows_link::link!("ieframe.dll" "system" fn IERegSetValueEx(lpsubkey : windows_sys::core::PCWSTR, lpvaluename : windows_sys::core::PCWSTR, reserved : u32, dwaitpe : u32, lpdata : *const u8, cbdata : u32) -> windows_sys::core::HRESULT);
...
windows_link::link!("ieframe.dll" "system" fn IERegisterWritableRegistryValue(guid : windows_sys::core::GUID, lppath : windows_sys::core::PCWSTR, lpvaluename : windows_sys::core::PCWSTR, dwaitpe : u32, lpdata : *const u8, cbmaxdata : u32) -> windows_sys::core::HRESULT);
