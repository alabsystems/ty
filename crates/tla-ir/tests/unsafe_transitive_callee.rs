...
use tla_ir::lower::{lower_entry_next_state_with_chunk, LoweringOptions};
...
fn hidden_loadprime_callee_reaches_next_state_lowering() {
    ...
    assert!(
        names
            .iter()
            .any(|name| name.starts_with("__trust_ir_callee_")
