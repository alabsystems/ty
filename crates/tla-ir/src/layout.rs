...
//! State layout for trust-ir lowering.
//!
...
mod tests {
    ...
    fn test_trivial_layout_basic() {
        let layout = TrustIrStateLayout::trivial(5);
    ...
    fn test_trivial_layout_empty() {
        let layout = TrustIrStateLayout::trivial(0);
