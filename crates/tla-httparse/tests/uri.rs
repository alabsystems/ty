...
// for TY zero-external-dependency posture (Part of #4250, Wave 36).
...
req! {
    urltest_192,
    b"GET /C:/Home/Domenic/Andrew Yates/GitHub/tmpvar/jsdom/test/level2/html/files/pix/submit.gif HTTP/1.1\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
        assert_eq!(req.path.unwrap(), "/C:/Home/Domenic/Andrew Yates/GitHub/tmpvar/jsdom/test/level2/html/files/pix/submit.gif");
        assert_eq!(req.version.unwrap(), 1);
        assert_eq!(req.headers.len(), 1);
        assert_eq!(req.headers[0].name, "Host");
        assert_eq!(req.headers[0].value, b"");
