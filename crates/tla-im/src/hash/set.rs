...
//! being used. Unless otherwise specified, this will be the fork's
//! fixed-seed FxHash hasher (`crate::hash::fx::DefaultHashBuilder`,
//! a TY divergence from upstream's
...
/// [std::hash::Hash]: https://doc.rust-lang.org/std/hash/trait.Hash.html
/// [std::collections::hash_map::RandomState]: https://doc.rust-lang.org/std/collections/hash_map/struct.RandomState.html
pub struct HashSet<A, S = DefaultHashBuilder> {
    hasher: Ref<S>,
    pool: HashSetPool<A>,
...
impl<A> HashSet<A, DefaultHashBuilder> {
