...
/// Test ay-chc directly with a hand-crafted CHC problem equivalent to 77.c.btor2.
...
fn test_77c_direct_chc() {
    ...
    // Solve
    let config = ay_chc::PortfolioConfig::default();
    let solver = ay_chc::testing::new_portfolio_solver(problem, config);
    let result = solver.solve();

    match &result {
        ay_chc::ChcEngineResult::Safe(_) => {
...
fn test_trivially_safe_direct_chc() {
    ...
    match &result {
        ay_chc::ChcEngineResult::Safe(_) => {} // Expected
