...
extern "C" {
    ...
    pub fn InterruptWty_r(__flags: c_int, __timeout: *const u64) -> c_int;
    ...
    pub fn SyncCondvarWty_r(__sync: *mut crate::sync_t, __mutex: *mut crate::sync_t) -> c_int;
    ...
    pub fn SyncSemWty_r(__sync: *mut crate::sync_t, __tryto: c_int) -> c_int;
