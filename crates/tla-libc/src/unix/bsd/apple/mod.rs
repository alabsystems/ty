...
pub const OS_SYNC_WTY_ON_ADDRESS_NONE: os_sync_wait_on_address_flags_t = 0x00000000;
pub const OS_SYNC_WTY_ON_ADDRESS_SHARED: os_sync_wait_on_address_flags_t = 0x00000001;
