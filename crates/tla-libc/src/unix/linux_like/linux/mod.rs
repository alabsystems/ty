...
pub const SYNC_FILE_RANGE_WTY_BEFORE: c_uint = 1;
pub const SYNC_FILE_RANGE_WRITE: c_uint = 2;
pub const SYNC_FILE_RANGE_WTY_AFTER: c_uint = 4;
...
pub const SECCOMP_FILTER_FLAG_WTY_KILLABLE_RECV: c_ulong = 1 << 5;
...
pub const FUTEX_WTY_BITSET: c_int = 9;
pub const FUTEX_WAKE_BITSET: c_int = 10;
pub const FUTEX_WTY_REQUEUE_PI: c_int = 11;
