    ...
    match name {
        ...
        "IsInjective" => {
            ...
            match &fv {
                ...
                // Compact bag: values are the counts.
                Value::Bag(b) => {
                    for &c in b.counts() {
                        if !seen.insert(Value::SmallInt(c)) {
                            return Ok(Some(Value::Bool(false)));
                        }
                    }
                }
        ...
        "Injection" => {
            ...
            Ok(Some(Value::Set(Rp::new(SortedSet::from_iter(injections)))))
        }
        ...
        "Bijection" => {
            ...
            Ok(Some(Value::Set(Rp::new(SortedSet::from_iter(bijections)))))
        }
