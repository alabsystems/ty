...
//! TLA+ to Rust code generator targeting ay SAT solver specifications.
//!
...
fn emit_floor_int_mod(lhs: String, rhs: String) -> String {
    ...
    format!(
        "({{ let __a = {lhs}; let __b = {rhs}; assert!(__b > 0, \"TLA+ % requires a positive divisor (got {{}})\", __b); let __r = __a % __b; if __r < 0 {{ __r + __b }} else {{ __r }} }})"
    )
}

/// Error type for ay code generation failures.
#[derive(Debug, Clone, thiserror::Error)]
#[non_exhaustive]
pub enum AYCodegenError {
...
/// Configuration for ay code generation.
#[derive(Debug, Clone)]
pub struct AYCodegenOptions {
...
impl Default for AYCodegenOptions {
    fn default() -> Self {
        Self {
...
pub fn generate_rust_module(module: &Module) -> String {
    generate_rust_module_with_options(module, &AYCodegenOptions::default())
}

/// Generate a standalone Rust module with explicit options.
#[must_use]
pub fn generate_rust_module_with_options(module: &Module, options: &AYCodegenOptions) -> String {
    let mut gen = AYCodeGenerator::new(module);
    gen.generate(options)
}

struct AYCodeGenerator<'a> {
    module: &'a Module,
    out: String,
...
impl<'a> AYCodeGenerator<'a> {
    ...
    fn generate(&mut self, options: &AYCodegenOptions) -> String {
        self.emit_header();
        self.emit_imports();
    ...
    fn emit_header(&mut self) {
        ...
        let _ = writeln!(self.out, "//! Auto-generated by tla-codegen ay_codegen.");
...
mod tests {
    ...
    #[test]
    fn test_ay_generate_counter_contains_struct() {
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_generate_counter_contains_init() {
        let module = make_counter_module();
        let code = generate_rust_module(&module);
        assert!(
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_generate_counter_contains_next() {
        let module = make_counter_module();
        let code = generate_rust_module(&module);
        assert!(
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_generate_counter_contains_invariant() {
        let module = make_counter_module();
        let code = generate_rust_module(&module);
        assert!(
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_generate_counter_contains_kani_harness() {
        let module = make_counter_module();
        let code = generate_rust_module(&module);
        assert!(
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_generate_no_kani_when_disabled() {
        let module = make_counter_module();
        let options = AYCodegenOptions {
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_type_inference_bool_variable() {
        let init_body = Expr::Eq(
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_type_inference_set_variable() {
        let init_body = Expr::Eq(
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_expr_to_rust_intdiv_negative_dividend() {
        let module = make_counter_module();
        let generator = AYCodeGenerator::new(&module);
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_expr_to_rust_intdiv_negative_divisor() {
        let module = make_counter_module();
        let generator = AYCodeGenerator::new(&module);
        let expr = Expr::IntDiv(
            Box::new(s(Expr::Int(7.into()))),
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_expr_to_rust_intdiv_both_negative() {
        let module = make_counter_module();
        let generator = AYCodeGenerator::new(&module);
        let expr = Expr::IntDiv(
            Box::new(s(Expr::Int((-7).into()))),
    ...
    fn floor_intmod_expr(lhs: i64, rhs: i64) -> String {
        format!(
            "({{ let __a = {lhs}_i64; let __b = {rhs}_i64; assert!(__b > 0, \"TLA+ % requires a positive divisor (got {{}})\", __b); let __r = __a % __b; if __r < 0 {{ __r + __b }} else {{ __r }} }})"
        )
    }

    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_expr_to_rust_mod_negative_dividend() {
        let module = make_counter_module();
        let generator = AYCodeGenerator::new(&module);
        let expr = Expr::Mod(
            Box::new(s(Expr::Int((-7).into()))),
    ...
    #[cfg_attr(test, ntest::timeout(10000))]
    #[test]
    fn test_ay_expr_to_rust_mod_positive_both() {
        let module = make_counter_module();
        let generator = AYCodeGenerator::new(&module);
        let expr = Expr::Mod(
            Box::new(s(Expr::Int(7.into()))),
