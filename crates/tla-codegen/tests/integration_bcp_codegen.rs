...
//!
//! Validates that the auto-generated BCP state machine (from `ty codegen --tir`
//! on specs/ay/BCP.tla) produces exactly 32 reachable states and 46 transitions,
//! matching TLC and the TY interpreter. Also compares against a hand-written
