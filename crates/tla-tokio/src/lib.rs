...
//
// TY verbatim fork of tokio 1.52.1 (MIT).
// Upstream: https://github.com/tokio-rs/tokio (tag tokio-1.52.1)
// Part of #4250 zero-external-dep posture (Wave 37, umbrella-only).
// Companion crates tokio-macros, tokio-stream, tokio-util, tokio-test
// remain EXTERNAL per umbrella-only scope (same pattern as Wave 33
// thiserror/thiserror-impl and Wave 30 syn/proc-macro2).
