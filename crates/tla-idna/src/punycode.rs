...
// Upstream `huge_encode` test removed — allocates u32::MAX+1 chars (~8GB) and
// was gated on an upstream slow-test skip attribute. Org rule #341 forbids
// skip/xfail test attributes, and the test is unsuitable for unskipped runs.
// Verbatim fork of idna 1.1.0 otherwise preserved (Part of #4250, Wave 23).
