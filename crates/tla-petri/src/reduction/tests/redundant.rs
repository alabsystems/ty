...
fn test_redundant_place_marking_expansion() {
    ...
    let marking_after_2 = reduced
        .net
        .fire(&marking_after_use, TransitionIdx(0))
        .expect("fire (test)");
    ...
    let marking_after_3 = reduced
        .net
        .fire(&marking_after_2, TransitionIdx(0))
        .expect("fire (test)");
    ...
    let marking_released = reduced
        .net
        .fire(&marking_after_use, TransitionIdx(1))
        .expect("fire (test)");
