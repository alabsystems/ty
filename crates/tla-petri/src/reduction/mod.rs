...
#[cfg(test)]
pub(crate) use apply::reduce_with_mode;
pub(crate) use apply::{
...
pub(crate) use universally_sound::reduce_dead_transitions_only;

#[cfg(test)]
mod tests;

#[cfg(test)]
mod universally_sound_tests;
