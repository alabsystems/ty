...
//! in the ay symbolic engine.
//!
//! These tests exercise the full translate pipeline via the public API:
//! AYTranslator -> translate_bool/translate_int -> assert -> check_sat -> get_model
//!
//! Part of #3749: Symbolic set/function/sequence/record encoding in ay.
