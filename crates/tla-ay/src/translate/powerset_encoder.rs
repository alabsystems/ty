...
//!
//! Extends the [`FiniteSetEncoder`](crate::FiniteSetEncoder) with higher-order set
//! operations needed for Apalache parity:
//!
...
//! [`FiniteSetEncoder::encode_cardinality`](crate::FiniteSetEncoder::encode_cardinality).
//!
//! Part of the Apalache-parity work (Gap 1 Phase 6).
