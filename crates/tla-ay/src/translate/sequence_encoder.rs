...
//!
//! ```no_run
//! use tla_ay::translate::sequence_encoder::SequenceEncoder;
...
//! # Errors
//!
//! Fallible encoder methods build ay array/Int terms through the solver and
//! propagate an [`AYError::Solver`](crate::AYError::Solver) on a term-constructor
//! rejection (e.g. a sort mismatch). They report no other error variants.
//!
//! Part of #3793
...
impl SequenceEncoder {
    ...
    pub fn empty_seq(&self, trans: &mut AYTranslator) -> AYResult<SeqTerm> {
    ...
    pub fn encode_head(&self, trans: &mut AYTranslator, seq: &SeqTerm) -> AYResult<Term> {
    ...
    fn declare_fresh_array(&self, trans: &mut AYTranslator, prefix: &str) -> AYResult<Term> {
