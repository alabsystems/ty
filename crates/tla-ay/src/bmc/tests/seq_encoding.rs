...
#[cfg_attr(test, ntest::timeout(10000))]
#[ignore = "ay-align(2026-06-20): AY soundly abstains (Unknown) on select-over-store free-array model-finding after its false-SAT hardening (ay 589685fa..08940ef6); concat's symbolic join index needs a store-chain-witness encoder adaptation. Not a wrong verdict. See docs/ay-alignment-followup-2026-06-20.md"]
#[test]
