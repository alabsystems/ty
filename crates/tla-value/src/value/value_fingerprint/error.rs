...
pub enum FingerprintError {
    ...
    I32Overflow {
        /// Rendered value (length or index) that exceeded `i32::MAX`.
        value: String,
        /// Static description of where the overflow occurred (e.g. set size).
        context: &'static str,
    },
    ...
    I64DomainOverflow {
        /// Minimum domain element of the interval function.
        min: i64,
        /// Offset from `min` whose sum overflows `i64`.
        offset: usize,
    },
...
/// Convenience alias for results produced while computing value fingerprints.
