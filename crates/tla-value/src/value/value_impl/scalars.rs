...
impl Value {
    ...
    /// Extract the boolean if this is a `Value::Bool`, else `None`.
    #[inline]
    ...
    /// Borrow the string contents if this is a `Value::String`, else `None`.
    ...
    /// Return a stable TLC-style type name for this value (e.g. `"Int"`,
    /// `"BOOLEAN"`, `"a set"`), used to build human-readable type-error messages.
    pub fn type_name(&self) -> &'static str {
        match self {
            ...
            | Value::AnySet
            | Value::SeqSet(_) => "Set",
            Value::Func(_) | Value::IntFunc(_) | Value::LazyFunc(_) | Value::Bag(_) => "Function",
            Value::Seq(_) => "Seq",
