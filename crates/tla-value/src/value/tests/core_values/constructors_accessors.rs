...
fn test_to_tuple_like_elements() {
    ...
    let int_func = Value::IntFunc(Rp::new(crate::value::IntIntervalFunc::new(
        1,
        2,
    ...
    let int_func_2 = Value::IntFunc(Rp::new(crate::value::IntIntervalFunc::new(
        2,
        3,
    ...
    let func2 = Value::Func(Rp::new(fb2.build()));
    ...
    let func3 = Value::Func(Rp::new(fb3.build()));
    ...
    let func4 = Value::Func(Rp::new(fb4.build()));
...
fn test_func_values() {
    ...
    let f = Value::Func(Rp::new(fb.build()));
