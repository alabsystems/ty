...
fn test_ordering_func_vs_intfunc_different_values() {
    ...
    let func = Value::Func(Rp::new(fb.build()));
    let intfunc = Value::IntFunc(Rp::new(IntIntervalFunc::new(1, 1, vec![Value::int(2)])));
...
fn test_ordering_intfunc_by_min_first() {
    ...
    let a = Value::IntFunc(Rp::new(IntIntervalFunc::new(
        1,
        2,
        vec![Value::int(1), Value::int(2)],
    )));
    let b = Value::IntFunc(Rp::new(IntIntervalFunc::new(
        2,
        3,
        vec![Value::int(1), Value::int(2)],
    )));
...
fn test_ordering_intfunc_by_max_then_values() {
    ...
    let a = Value::IntFunc(Rp::new(IntIntervalFunc::new(1, 1, vec![Value::int(1)])));
    let b = Value::IntFunc(Rp::new(IntIntervalFunc::new(
        1,
        2,
        vec![Value::int(1), Value::int(2)],
