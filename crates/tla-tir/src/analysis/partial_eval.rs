...
//! downstream pipeline (`inlining` → `const_prop` → trust-ir lowering) then sees
...
//! symbol table on every access. A compiled TY binary with partial evaluation
...
//! is cheap to enforce.
//!
//! Part of #4251 (trust_cg + trust-ir supremacy, pillar 1).
