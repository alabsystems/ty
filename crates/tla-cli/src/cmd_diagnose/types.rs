...
pub(super) struct BaselineSpec {
    ...
    /// TY-specific expected state count. When present, `diagnose` compares
    /// TY output against this field instead of `tlc.states`. This handles
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) ty_expected_states: Option<u64>,
...
impl BaselineSpec {
    ...
    /// violations in TY explores states TLC never saw, causing state count
...
pub(super) struct SpecResult {
    ...
    pub(super) ty_status: Option<String>,
    pub(super) ty_states: Option<u64>,
...
impl DiagnoseCheckPolicy {
    ...
    pub(super) fn effective_workers(self) -> usize {
        match self {
            ...
            // experience for `ty check`, and state counts are deterministic
    ...
    /// `ty check` subprocess command. The `continue_on_error` parameter
...
pub(super) struct JsonSpecResult {
    ...
    pub(super) ty_states: Option<u64>,
    pub(super) tlc_states: Option<u64>,
    pub(super) ty_error: Option<String>,
    pub(super) tlc_error_type: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) error_details: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
