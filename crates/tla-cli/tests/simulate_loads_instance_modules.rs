...
fn simulate_loads_standalone_instance_modules() {
    let dir = TempDir::new("ty-simulate-instance-modules");
...
fn check_simulate_flag_loads_standalone_instance_modules() {
    let dir = TempDir::new("ty-check-simulate-instance-modules");
