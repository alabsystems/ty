...
//!
//! Run with: `cargo test -p tla-cli --features ay --test pdr_flag_conflicts`
//! The --pdr CLI flag requires the ay feature.

#![cfg(feature = "ay")]

mod common;

/// Helper: run ty with --pdr and an extra flag, expect clap conflict error.
