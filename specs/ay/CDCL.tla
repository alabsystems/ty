...
\*
\* Models the core CDCL loop as implemented in ay-sat (~/ay/crates/ay-sat/src/):
...
\*
\* Reference: ay-sat conflict.rs (ConflictAnalyzer), solver/conflict_analysis.rs
...
\*
\* Reference: ay-sat solver/conflict_analysis.rs lines 178-265
...
\* Reference: ay-sat conflict.rs compute_backtrack_level()
...
\*
\* Reference: ay-sat solver/conflict_analysis.rs analyze_conflict()
AnalyzeConflict ==
    /\ status = "running"
    /\ conflict = TRUE
