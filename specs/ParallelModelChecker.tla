...
\* TLA+ Specification for TY's Parallel Model Checker
\*
\* Purpose: Verify correctness of work-stealing parallel state exploration
\* Author: TY Researcher
\* Date: 2026-01-19
\* Re: #282 - TY needs TLA+ specification for its own parallel execution
\*
\* This spec models:
...
\* Created: 2026-01-19 by TY Researcher
\* Purpose: Verify TY's parallel model checker correctness (#282)
