...
# unsolvable. 300s inner gives the ay-sat IC3 loop room to converge on the
...
INNER_TIMEOUT=${1:-300}
OUTER_TIMEOUT=${2:-330}
BINARY=${3:-/tmp/ty-hwmcc/release/ty}
BENCH_DIR="$HOME/hwmcc/benchmarks/bitlevel/safety"
RESULTS_CSV="/tmp/hwmcc_ty_results.csv"
