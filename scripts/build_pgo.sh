#!/usr/bin/env bash
# Build TY with Profile-Guided Optimization (PGO)
#
...
# PGO builds do `cargo clean`, which is unsafe when sharing `CARGO_TARGET_DIR`.
# Force a dedicated target dir.
...
TY="$CARGO_TARGET_DIR/release-perf/ty"
...
echo "=== Done! ==="
echo "PGO-optimized binary available at: $TY"
