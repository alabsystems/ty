...
# Licensed under the Apache License, Version 2.0
#
# Thin compatibility wrapper for the eval/check canary gate.
#
# Source of truth:
#   ty canary-gate --kind eval
#
# Usage:
#   scripts/check_eval_canaries.sh [--mode warn|enforce] [--staged] [--changed-files FILE...]
...
#
# Environment:
#   TY_EVAL_CANARY_SKIP=1   Skip the Rust gate after the CLI launches
#   TY_EVAL_CANARY_WARN=1   Downgrade failures to advisory warnings
#   TY_EVAL_CANARY_TIMEOUT  Per-spec timeout in seconds (default: 30)
